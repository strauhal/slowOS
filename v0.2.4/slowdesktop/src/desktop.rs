...
//! - Bottom bar with system menu, apps menu, search, and multitasking
...
impl DesktopApp {
    pub fn new(_cc: &eframe::CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            show_about: false,
            show_shutdown: false,
            status_message: "welcome to slowOS v0.2.4".to_string(),
    ...
    fn load_icon_textures(&mut self, ctx: &Context) {
        ...
        let icons: &[(&str, &[u8])] = &[
            ...
            ("slowpaint", include_bytes!("../../icons/app_icons/icons_paint.png")),
            ("slowdesign", include_bytes!("../../icons/app_icons/icons_design.png")),
            ("books", include_bytes!("../../icons/app_icons/icons_read.png")),
            ("chess", include_bytes!("../../icons/app_icons/icons_slowChess.png")),
            ("files", include_bytes!("../../icons/app_icons/icons_files.png")),
            ("music", include_bytes!("../../icons/app_icons/icons_music.png")),
            ("trash", include_bytes!("../../icons/app_icons/icons_trash.png")),
            ("slowview", include_bytes!("../../icons/app_icons/icons_view.png")),
    ...
    fn draw_icon_label(painter: &Painter, pos: Pos2, text: &str, selected: bool) {
        let label_rect = Rect::from_min_size(
            Pos2::new(pos.x - 8.0, pos.y + ICON_IMAGE + 4.0),
    ...
    fn draw_icon(
        ...
        // Icon box
        let icon_rect =
            Rect::from_min_size(Pos2::new(pos.x + (ICON_SIZE - ICON_IMAGE) / 2.0, pos.y), Vec2::new(ICON_IMAGE, ICON_IMAGE));
    ...
    fn open_folder(&mut self, index: usize) {
        ...
        match self.process_manager.launch_with_args("files", &[&path_str]) {
    ...
    /// Draw the bottom bar (system menu, apps, search, minimized apps, status)
    ...
    fn open_file_with_app(&mut self, path: &std::path::Path) {
        // Handle directories - open in files
        if path.is_dir() {
            let path_str = path.to_string_lossy().to_string();
    ...
    fn handle_keys(&mut self, ctx: &Context) {
        ...
        if launch_term {
            self.launch_app_direct("terminal");
        }
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ...
                if self.cached_app_indices.is_none() || running_count != self.last_running_count {
                    let hidden_from_desktop = ["trash", "credits", "terminal"];

...
impl eframe::App for SlowFilesApp {
    fn update(&mut self, ctx: &Context, _frame: &mut eframe::Frame) {
        ...
        if slowcore::minimize::check_restore_signal("files") {
            ...
            menu_bar(ui, |ui| {
                ...
                ui.menu_button("file", |ui| {
                    if ui.button("new window").clicked() {
                        // Launch a new instance of files
        ...
        match win_action {
            ...
            WindowAction::Minimize => {
                ...
                slowcore::minimize::write_minimized("files", &title);
...
fn format_size(bytes: u64) -> String {
    slowcore::storage::format_size(bytes)
}
...
fn slow_app_for_ext(ext: &str) -> Option<&'static str> {
    match ext {
        ...
        "mp3" | "wav" | "flac" | "ogg" | "aac" | "m4a" => Some("music"),
        "swd" => Some("slowwrite"),
        _ => None,
    }
}

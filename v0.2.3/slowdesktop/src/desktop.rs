...
impl DesktopApp {
    pub fn new(_cc: &eframe::CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            show_about: false,
            show_shutdown: false,
            status_message: "welcome to slowOS v0.2.3".to_string(),
    ...
    fn load_icon_textures(&mut self, ctx: &Context) {
        ...
        let icons: &[(&str, &[u8])] = &[
            ...
            ("slowreader", include_bytes!("../../icons/app_icons/icons_read.png")),
            ("slowsheets", include_bytes!("../../icons/app_icons/icons_sheets_1.png")),
            ("slowchess", include_bytes!("../../icons/app_icons/icons_slowChess.png")),
            ("slowfiles", include_bytes!("../../icons/app_icons/icons_files.png")),
            ("slowmusic", include_bytes!("../../icons/app_icons/icons_music.png")),
